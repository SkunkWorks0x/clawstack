...
export type BehaviorEventType = 'tool_call' | 'network_request' | 'file_access' | 'memory_write' | 'memory_read' | 'skill_execution' | 'message_send' | 'process_spawn';
...
export type EventChannel = 'session.started' | 'session.ended' | 'behavior.detected' | 'behavior.blocked' | 'cost.recorded' | 'cost.limit_warning' | 'cost.limit_exceeded' | 'memory.entity_created' | 'memory.entity_accessed' | 'trust.level_changed' | 'pipeline.step_completed' | 'pipeline.completed' | 'pipeline.failed';
