...
exports.GracefulCompaction = void 0;
const smart_capture_js_1 = require("./smart-capture.js");
const token_recall_js_1 = require("./token-recall.js");
class GracefulCompaction {
    graph;
    bus;
    capture;
    recall;
    constructor(graph, bus) {
        ...
        this.recall = new token_recall_js_1.TokenRecall(graph, bus);
    }
    /**
     ...
     */
    async afterCompaction(options) {
        const { agentId, workspace, tokenBudget, priorityEntityIds, } = options;
     ...
     */
    async compactionCycle(input, injectionBudget) {
...
exports.GracefulCompaction = GracefulCompaction;
//# sourceMappingURL=graceful-compaction.js.map